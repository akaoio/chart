...
|---|---|---|:--:|---|
| `Annotate` | class | `Annotate.tsx` | ☐ | |
| `BarAnnotation` | class | `BarAnnotation.tsx` | ☐ | |
| `Label` | class | `Label.tsx` | ☐ | |
| `LabelAnnotation` | class | `LabelAnnotation.tsx` | ☐ | |
| `SvgPathAnnotation` | class | `SvgPathAnnotation.tsx` | ☐ | |
