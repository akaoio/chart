...
export const eachMeasureDefaults = {
    index: undefined,
    mode: "both",
    selected: false,
    x1Value: undefined,
...
/**
 * One measurement box, its two defining corners, and whole-body drag — the same
 * three-part layout as `EachShape`, with the readout living inside the leaf.
 */
export class EachMeasure extends ElementBase {
    #props
    #dragStart
    #hover = false
    ...
    constructor() {
        super()
        this.#props = defineProperties(this, eachMeasureDefaults)
    ...
    #build() {
        ...
        if (this.#children === null) {
            this.#children = {
                body: document.createElement("chart-interactive-measure"),
        ...
        Object.assign(body, {
            ...
            ...(props.formatPercent !== undefined ? { formatPercent: props.formatPercent } : {}),
            ...(props.formatDuration !== undefined ? { formatDuration: props.formatDuration } : {}),
...
define("chart-each-measure", EachMeasure)
