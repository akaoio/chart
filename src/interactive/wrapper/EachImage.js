...
export const eachImageDefaults = {
    index: undefined,
    interactive: true,
    selected: false,
    start: undefined,
...
export class EachImage extends ElementBase {
    #props
    #dragStart
    #hover = false
    #children = null
    ...
    constructor() {
        super()
        this.#props = defineProperties(this, eachImageDefaults)
    ...
    #build() {
        ...
        const { start, end, src, opacity, interactive, appearance, hoverText, selected } = props
        ...
        if (this.#children === null) {
            this.#children = {
                body: document.createElement("chart-interactive-image"),
    ...
    /** Kéo thân: cả hai góc dời cùng quãng pixel — ảnh giữ nguyên cỡ. */
...
define("chart-each-image", EachImage)
