/**
 * Default colours per indicator, in a light and a dark variant.
 *
 * These are what make two charts of the same indicator look alike without anyone
 * choosing colours — and what a theme switch swaps in one place.
 */
export const themes = {
    light: {
        BollingerBand: {
